...
export default function PrivacyPage() {
  return (
    <PublicPageShell eyebrow="Informacoes legais" title="Politica de privacidade">
      ...
      <p>Quando a profissional escolhe importar PDF, Word .docx ou imagem, a leitura e realizada no proprio navegador apenas para sugerir o preenchimento da ficha. Os arquivos nao sao enviados ou guardados pelo servidor deste aplicativo. Se a profissional salvar o rascunho de uma aplicacao, somente o texto extraido necessario para comparacao fica registrado localmente no navegador.</p>
